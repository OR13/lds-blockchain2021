...
export interface SignatureOptions {
  key?: BlockchainVerificationMethod2021;
  date?: any;
  signer?: any;
}

export class BlockchainSignature2021 {
  public useNativeCanonize: boolean = false;
  public key?: BlockchainVerificationMethod2021;
  public proof: any;
  public date: any;
  public creator: any;
  public type: string = 'https://w3id.org/security#BlockchainSignature2021';
  public signer: any;
  public verifier: any;
  ...
  // expansionMap,
  any) {
    return proof.type === 'sec:BlockchainSignature2021';
  }
  ...
  async verifySignature({ verifyData, verificationMethod, proof }: any) {
    ...
    if (!verifier) {
      ...
      if (!verificationMethod.blockchainAccountId) {
        console.warn(
          'The current security context used by JSON-LD Signatures does not understand blockchainAccountId.'
        );
      ...
      const key = await BlockchainVerificationMethod2021.from(
        verificationMethod
      );
